...
import gestorAplicacion.Peliculas.Pelicula.CategoriaPelicula;
...
public class Cine {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Pelicula pelicula1 = new Pelicula("Terminator", 2000, CategoriaPelicula.ACCION);
        Pelicula pelicula2 = new Pelicula("Barbie", 2000, CategoriaPelicula.COMEDIA);
        Pelicula pelicula3 = new Pelicula("Inception", 3000, "2:20 pm",CategoriaPelicula.TERROR);
        Pelicula pelicula4 = new Pelicula("lol", 20, "1:20 pm", CategoriaPelicula.CIENCIA_FICCION);
